...
<?php include ("sidebar.php")?>
  ...
  <div class="content-container">
    <p class="path_leave">PERFORMANCE > <a href="workstatus.php">WORK STATUS</a></p>
    ...
    <h1 class="title">Work Status Summary</h1>
      ...
      <?php
         ...
         if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
               ...
               echo "</td><td> 
                     <div class='btn-group'> 
                        <a href='workstatus.php?user_id=$row[user_id]' class='btn2' value='Delete'>Delete</a>
                     </div>";
               echo "</td></tr>";
            }
            echo "</tbody>";
